...
public class CounterServiceImpl implements CounterService {
    ...
    @Override
    public void incrementComment(String entityType, String entityId) {
        eventProducer.publish(CounterEvent.of(entityType, entityId, "comment", CounterSchema.IDX_COMMENT, 0, 1));
        eventPublisher.publishEvent(CounterEvent.of(entityType, entityId, "comment", CounterSchema.IDX_COMMENT, 0, 1));
    }

    @Override
    public void decrementComment(String entityType, String entityId) {
        eventProducer.publish(CounterEvent.of(entityType, entityId, "comment", CounterSchema.IDX_COMMENT, 0, -1));
        eventPublisher.publishEvent(CounterEvent.of(entityType, entityId, "comment", CounterSchema.IDX_COMMENT, 0, -1));
    }
